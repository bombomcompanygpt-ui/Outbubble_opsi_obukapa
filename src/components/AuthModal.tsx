...
import { X, LogIn, UserPlus, Globe, Sparkles, CheckCircle, ShieldCheck, ArrowRight, Lock, Key, Dices } from 'lucide-react';
...
export const AuthModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-[#031466]/70 backdrop-blur-md overflow-y-auto font-sans">
      <div 
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 pt-2">
                ...
                <div className="relative group">
                  <button
                    onClick={handleContinueAsGuest}
                    className="w-full p-4 sm:p-5 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-2xl font-black text-base shadow-lg hover:shadow-emerald-200 hover:scale-[1.01] active:scale-95 transition-all flex items-center justify-between border border-emerald-400 cursor-pointer pr-14"
                  >
                    <div className="flex items-center gap-3.5 text-left">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] text-emerald-100 font-normal">
                          USN Tamu: <span className="font-bold underline">{user?.username || 'Penjelajah'}</span>
                        </p>
                      </div>
                    </div>
                  </button>
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 p-2.5 bg-white/20 hover:bg-white/30 text-white rounded-xl transition-all cursor-pointer backdrop-blur-sm border border-white/30 active:scale-90"
                  >
                    <Dices size={18} className={isRerolling ? "animate-spin" : ""} />
                  </button>
                </div>
