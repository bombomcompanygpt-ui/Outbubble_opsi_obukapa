                ...
                return (
                  ...
                  <div className="p-6 md:p-8 flex-1 flex flex-col justify-between bg-white relative z-10">
                    <div className="space-y-2.5 md:space-y-3">
                      <h3 className="text-lg md:text-xl font-black text-slate-900 leading-snug line-clamp-2 group-hover:text-indigo-600 transition-colors">
                        {item.title}
                      </h3>
                      <p className="text-xs sm:text-sm text-slate-600 font-normal leading-relaxed line-clamp-2 md:line-clamp-3">
                        {item.desc}
                      </p>
                    </div>
                    ...
                    <div className="flex items-center justify-between pt-4 mt-4 border-t border-slate-100">
                      <button 
                        ...
                        className="flex items-center gap-1.5 font-extrabold text-xs uppercase tracking-wider text-indigo-600 hover:text-indigo-800 transition-colors cursor-pointer"
                      >
                        {isTikTok ? 'Tonton Sumber' : 'Buka Referensi'} <ExternalLink size={14} />
                      </button>
                      ...
                      <button 
                        ...
                        aria-label="Simpan Referensi"
                        className={cn(
                          "p-2.5 md:p-3 rounded-xl transition-all shadow-sm cursor-pointer",
                          user?.bookmarks.includes(item.id) 
                            ? "bg-indigo-600 text-white shadow-indigo-600/30" 
                            : "bg-slate-50 text-slate-400 hover:bg-slate-100 border border-slate-200"
                        )}
                      >
                        <Bookmark size={16} fill={user?.bookmarks.includes(item.id) ? "white" : "none"} />
                      </button>
                    </div>
                  </div>
                </motion.div>
